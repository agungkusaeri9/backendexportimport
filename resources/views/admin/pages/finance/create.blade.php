        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h6 class="text-center">Tambah Finance</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.finances.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="job_number" class="form-control @error('job_number') is-invalid @enderror" id="job_number" value="{{ old('job_number') }}">
                                @error('job_number')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="consigne" class="form-control @error('consigne') is-invalid @enderror" id="consigne" value="{{ old('consigne') }}">
                                @error('consigne')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="invoice" class="form-control @error('invoice') is-invalid @enderror" id="invoice" value="{{ old('invoice') }}">
                                @error('invoice')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="payment_status" class="form-control @error('payment_status') is-invalid @enderror" id="payment_status" value="{{ old('payment_status') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="delivery_order" class="form-control @error('delivery_order') is-invalid @enderror" id="delivery_order" value="{{ old('delivery_order') }}">
